...
<!--"星"-->
        ...
        <path class="cls-test" d="M140.84,110.76c-19.18,1.72-30.91,1.11-40.9,4.01-2.94,.85-1.36,11.62,0,13.78,11.54-.5,44.34-1.84,47.31-3.91,.92-3.49,.9-11-.62-13.58-2.63-.64-3.94-.47-5.8-.3Z"/>
        <path class="cls-test" d="M117.93,130.82c-4.94,.34-7.95,.85-17.37,1.64-2.43,2.4-1.07,11.99,.62,14.4,7.77-.35,15.64-.75,23.58-1.21,7.65-.44,15.22-.93,22.7-1.47,1.22-3.74,1.1-12.27-.82-15.02-.82-.04-19.53,1.02-28.71,1.65Z"/>
<!--"彩"-->
...
<!--"常"-->
        ...
        <path class="cls-test" d="M237.77,294.15c-2.81,.82-5.62,1.65-8.43,2.47-.35,1.73,.38,3.72,1.65,4.53,3.09-.82,6.17-1.65,9.26-2.47,.07-.07,.14-.14,.21-.21-.55-1.44-1.1-2.88-1.65-4.32h-1.03Z"/>
<!--"盤"-->
        ...
        <path class="cls-test" d="M270.69,273.79c-.21,.07-.41,.14-.62,.21-.48,3.27,.07,6.07-1.03,9.05v.21c3.07-.13,7.62-1.58,8.64-3.91-4.19-.84-3.84-2.5-5.55-5.55h-1.44Z"/>
        <path class="cls-test" d="M258.76,279.55c-1.23,.62-2.47,1.23-3.7,1.85,.62,1.44,1.23,2.88,1.85,4.32,.21,.07,.41,.14,.62,.21,1.44-.82,2.88-1.65,4.32-2.47-.55-1.23-1.1-2.47-1.65-3.7-.48-.07-.96-.14-1.44-.21Z"/>
        <path class="cls-test" d="M276.05,283.09c-1.38,.34-1.62,.32-2.96,1.23,.98,.35,2.47,.48,3.29,.62,.27-.34,.55-.69,.82-1.03,.07-.55,.03-.68,.09-1.22-.48,0-.79,.29-1.25,.4Z"/>
        <path class="cls-2" d="M256.29,281.19c1.95-.04,2.65,.31,3.7,1.03,.07,.55,.14,1.1,.21,1.65-1.79,1.14-4.12-.94-3.91-2.67Z"/>
        <path class="cls-test" d="M278.47,293.02c-.48,.27-1.13,.62-1.61,.9-.42,2.17,1.1,3.93,1.98,5.68,.75-.27,1.3-.67,2.05-.94-.08-2.32-.81-4.72-2.42-5.63Z"/>
        <path class="cls-test" d="M272.54,295.85c-.48,.27-1.46,.81-1.94,1.08,.48,3.15,.86,3.19,2.11,5.57,.75-.27,1.47-.76,2.23-1.03-.07-2.42-.5-4.91-2.4-5.62Z"/>
        <path class="cls-test" d="M264.52,298.88c.75,2.4,.95,3.96,2.14,6.24,.68-.13,2.06-.79,2.06-.86-.39-1.94-.61-3.04-1.94-6-.41-.07-1.92,.34-2.26,.62Z"/>
<!--        "22"-->
